...
func (c *diskCache) Put(kind cache.EntryKind, projectName string, hash string, expectedSize int64, r io.Reader) error {
	c.mu.Lock()
...
func (c *diskCache) Get(kind cache.EntryKind, projectName string, hash string) (rdr io.ReadCloser, sizeBytes int64, err error) {
